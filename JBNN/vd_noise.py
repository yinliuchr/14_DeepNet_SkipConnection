...
folder_name = 'Vdn_to_24_stat3--' + str(tpn) + '_tpn'
...
def main():
    ...
    final_loss_dense = np.array(final_loss_dense).reshape(10, 22)
    final_loss_plain = np.array(final_loss_plain).reshape(10, 22)
