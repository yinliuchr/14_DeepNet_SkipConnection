...
def main():
    ...
    for j in range(10):
        for i in x_axis:
            ...
            fld.append(jbn(global_lr, i, 3, 3))
    ...
    np.save('plain_mean.npy', plain_mean)
    np.save('res_mean.npy', res_mean)
    np.save('dense_mean.npy', dense_mean)

    np.save('plain_std.npy', plain_std)
    np.save('res_std.npy', res_std)
    np.save('dense_std.npy', dense_std)
    ##=========================================================================================================
    ...
    plt.savefig(folder_name + '/loss_vs_depth--noisy_stat2.eps')
