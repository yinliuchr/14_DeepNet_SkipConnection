...
data = xlrd.open_workbook('MNIST_runs4_w32.xlsx')
...
folder_name = 'MNIST_figures_tpn'
create_dir(folder_name)

figure_plot(0, 'Validation Accuracy with Training Data Size', 'training data size', 'validation accuracy', 4, folder_name + '/MNIST_runs4_w32_val_acc.eps' )
figure_plot(1, 'Validation Loss with Training Data Size', 'training data size', 'validation loss', 1, folder_name + '/MNIST_runs4_w32_val_loss.eps' )
# figure_plot(2, 'Validation Accuracy with Training Data Size', 'training data size', 'validation accuracy', 4, folder_name + '/MNIST_runs4_w64_val_acc.eps' )
# figure_plot(3, 'Validation Loss with Training Data Size', 'training data size', 'validation loss', 1, folder_name + '/MNIST_runs4_w64_val_loss.eps' )
# figure_plot(4, 'Validation Accuracy with Training Data Size', 'training data size', 'validation accuracy', 4, folder_name + '/MNIST_runs4_w128_val_acc.eps' )
# figure_plot(5, 'Validation Loss with Training Data Size', 'training data size', 'validation loss', 1, folder_name + '/MNIST_runs4_w128_val_loss.eps' )